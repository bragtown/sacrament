...
/**
 * @ngdoc service
 * @name programApp.HymnFact
 * @description
 * # HymnFact
 * Factory in the programApp.
 */
angular.module('programApp')
  .factory('HymnFact', function () {
    // Service logic
    // ...
...
var presiding = "Bishop Daniel Wright"
var conducting = "Brother Ross Peterson"
var organist = "Sister Donna Chestnut"
var chorister = "Sister Kalli Unopulos"

var image = {
      name: "Hartford Connecticut Temple",
      source: "http://www.ldschurchtemples.com/hartford/images/hartford-mormon-temple.jpg"
}
var programName = "";
var fast = false;
var program = false;
var youthSpeakers = ["Brother Jordan Harvey"] 
var pSpeakers = ["Brother McKay Barney"];
  var aSpeakers = ["Brother Rob Ethington"];
  var invocation = "Sister Lynette Smith";
  var benediction = "Brother Chris Smith";
...
var closing = 163;
  ...
  var announcements = [
    {
      ...
      data: "Our Ward will be in charge of cleaning the building in January. Please sign up!"
    }
    ,{
      name: "Provo Open House",
      data: "Reservations for the Provo City Center Temple public open house will be available to the general public at tickets.lds.org and by phone at 855-537-2000. The free open house starts on Friday, January 15, and will go through Saturday, March 5, 2016"
    }
  ...
  var emergencyPrep = {
    ...
    recipeName: "Taco Soup",
    recipe: [
      "1 can kidney beans (or any kind you like) ",
      "1 can diced tomatoes w/chilies",
      "1 can corn",
      "hamburger or bottled meat",
      "1 pckg taco seasoning", 
      "Mix together and Heat.  You can add more beans or tomatoes if you like. Serve with cheese, chips, and sour cream."
    ]
  }
  var sAnnouncements = [
  ]
